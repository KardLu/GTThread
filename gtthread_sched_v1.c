...
int gtthread_join(gtthread_t thread, void **status){
  ...
  gtthread *gt = gtthread_byID(thread);
  // bool error = gtthread_equal(current->id, thread) || (gt == NULL) || gtthread_equal(gt->joining_id, current->id);
